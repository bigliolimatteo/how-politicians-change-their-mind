    ...
    def read_data(self, input_directory: str):
        ...
        for filename in os.listdir(input_directory):
            if filename.endswith("json"):
                ...
                input_data[politician_name] = self.extract_relevant_data_from_file(file)
